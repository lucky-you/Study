...
public class Recorder implements Camera.PreviewCallback {
    ...
    private void initFilter() {
        ...
        boolean hflip = false;
        rotation = (rotation + mBuilder.mCameraOrientationDetector.getOrientation()) % 360;
    ...
    public void start() throws FrameRecorder.Exception, FrameFilter.Exception {
        ...
        int rotation = mBuilder.mCameraOrientationDetector.getOrientation();
    ...
    public static class Builder {
        ...
        public Builder orientationDetector(@NonNull CameraOrientationDetector cameraOrientationDetector) {
            mCameraOrientationDetector = cameraOrientationDetector;
            return this;
        }
        ...
        public Recorder build() throws IllegalArgumentException {
            ...
            if (mCameraOrientationDetector == null) {
