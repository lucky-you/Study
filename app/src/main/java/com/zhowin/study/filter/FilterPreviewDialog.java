package com.zhowin.study.filter;
...
import com.zho.recorder.Entity.FilterInfo;
import com.zho.recorder.OpenGL.Filter.ChooseFilter;
...
public class FilterPreviewDialog extends Dialog {
    ...
    private void initListview() {
        ...
        mListView.setLayoutManager(new LinearLayoutManager(mContext, LinearLayout.HORIZONTAL, false));
    ...
    public void show() {
        super.show();
        Log.e("xy", "show: " + this.mdatas.size());
    }
    ...
    class CommAvatarAdapter extends RecyclerView.Adapter<FilterInfoHolder> {
        ...
        public void onBindViewHolder(@NonNull FilterInfoHolder holder, int position) {
            ...
            Log.e("xy", "onBindViewHolder: " + mdatas.get(position).getRid());
        }
    ...
    public class FilterInfoHolder extends BaseRecViewHolder {
        ...
        public FilterInfoHolder(View rootView) {
            ...
            mLlWrap.setOnClickListener(v -> {
                Log.e("xy", "onReply: 选择了 " + getAdapterPosition());
                if (mListener != null) {
    ...
    class BaseRecViewHolder extends RecyclerView.ViewHolder {
