 ...
 * description: 录制的按钮
 */
public class RecorderVideoView extends View {
    ...
    public RecorderVideoView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RecorderVideoView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
