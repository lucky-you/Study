...
//        LogUtils.mLogEnable = false;
        ...
        mRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                if (dx != 0) {//去掉奇怪的内存疯涨问题
                    ...
                    Log.v("xy", String.format("dx=%s, dy=%s, mScrolledX=%s", dx, dy, mCurrentItemOffset));
    ...
    private void computeCurrentItemPos() {
        ...
        if (pageChanged) {
            ...
            Log.d("xy", String.format("=======onCurrentItemPos Changed======= tempPos=%s, mCurrentItemPos=%s", tempPos, mCurrentItemPos));
        }
    }
    ...
    private void onScrolledChangedCallback() {
        ...
        Log.d("xy", String.format("offset=%s, percent=%s", offset, percent));
        View leftView = null;
        View currentView;
        View rightView = null;
